...
if not app.session.member_id then
                    ui.container {
                        ...
                        content = function()
                             ui.container {
                                attr = { class = "col-md-4 col-md-col-md-offset-4 text-center" },
                                content = function()
												ui.image {
                                			attr = { class = "" },
                    ...
                    ui.container {
                        ...
                        content = function()
                            ...
                            ui.container {
                                attr = { class = "col-md-8 col-md-col-md-offset--2 text-center" },
                                content = function()
                                    ui.heading {
                                        level = 1,
                                        content = function()
...
if app.session.member_id then
    ...
    ui.container {
        ...
        content = function()
                                                            ...
                                                            content = function()
                                                                ui.heading {
                                                                    ...
                                                                    content = function()
                                                                        ...
                                                                        ui.tag { tag = "col-md-", attr = { id = "current_location" }, content = "" }
                        ...
                        ui.container {
                            ...
                            content = function()
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "col-md-5 col-md-col-md-offset-1 spaceline" },
                                            content = function()
                                                ui.heading {
                                                    level = 1,
                                                    content = function()
                      ...
                      ui.container{attr = {class = "row" },content = function()
                        ...
                        ui.container{ attr = { class  = "col-md-12 text-left" }, content = function()
                          ui.heading{level=4,content=function()
                              ...
                              slot.put("&nbsp;")
                              ui.tag{ tag="col-md-", attr = { id = "last_location"}, content="" }
            ...
            ui.container {
                attr = { class = "col-md-col-md-offset--5 col-md-4 text-right spaceline " },
                content = function()
                    ui.heading { level = 3, content = "La prima volta? clicca qui:" }
                end
            }
            ui.container {
                attr = { class = "col-md-1 text-left spaceline" },
                content = function()
            ...
            ui.container {
                ...
                content = function()
                    ui.container {
                        attr = { class = "col-md-10 col-md-col-md-offset-1 text-center" },
                        content = function()
                                                            ...
                                                            ui.container {
                                                                ...
                                                                content = function()
                                                                    ui.container {
                                                                        ...
                                                                        content = function()
                                                                            ui.container {
                                                                                attr = { class = "col-md-2 col-md-col-md-offset-1 spaceline" },
                                                                                content = function()
                                                                                    ui.image {
                                                                            ...
                                                                            ui.link {
                                                                                ...
                                                                                attr = { class = "col-md-9 text-center spaceline" },
                                                                                content = function()
                                                                                    ui.heading {
                                                                                        level = 4,
