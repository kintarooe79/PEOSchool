                                ...
                                content = function()
                                    ui.field.popover {
                                        attr = {
                                            ...
                                            datacontent = _ "<iframe width='560' height='315' src='https://www.youtube.com/embed/viLGvff5GsY' frameborder='0' allowfullscreen></iframe>",
                                            datahtml = "true",
                                            class = "text-center"
                                        },
                                        content = function()
                                                ...
                                                ui.container {
                                                    ...
                                                    content = function()
                                                            ...
                                                            content = function()
                                                                ui.container {
                                                                    ...
                                                                    content = function()
                                                                        ui.heading {
                                                                            level = 1,
                                                                            content = _ "Issue Brief Description"
                                                                        }
                                                                    end
                                                                }
                                                            end
                                                        ...
                                                        ui.container {
                                                            ...
                                                            content = function()
                                                                ui.container {
                                                                    attr = { class = "col-md-10 col-md-offset-1 text-center spaceline-bottom" },
                                                                    content = function()
                                                                        ui.tag {
                                                                            tag = "textarea",
                                                                            attr = {
