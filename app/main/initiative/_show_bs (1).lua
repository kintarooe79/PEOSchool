...
ui.title(function()
    ui.container {
        ...
        content = function()
            ...
            ui.container {
                attr = { class = "col-md-6 text center spaceline2" },
                content = function()
                            ui.container {
            ...
            ui.container {
                attr = { class = "col-md-1 col-md-col-md-offset-1 text-center spaceline2" },
                content = function()
                    ui.field.popover {
                        attr = {
                            dataplacement = "left",
    ...
    ui.container {
        ...
        content = function()
            ui.container { attr = { class = "col-md-3" }, content = function() slot.put('<div data-url="' .. url .. '" class="addthis_sharing_toolbox"></div>') end }
            ui.container {
                ...
                content = function()
                    ...
                    ui.tag {
                        ...
                        attr = {
                            id = "select_btn",
                            href = "#",
                            class = "btn btn-primary inline-block h3"
                        },
                        content = function()
                ...
                ui.container {
                    ...
                    content = function()
                        ...
                        if initiative.revoked or initiative.issue.fully_frozen and initiative.issue.closed or initiative.admitted == false then
                            title_class = title_class .. " col-md-11"
                            if initiative.revoked then
                                title_class = title_class .. " revoked"
                            end
                        else title_class = title_class .. " col-md-12"
                        end
                        ui.tag {
                            tag = "div",
                            attr = { class = "label text-center" },
                            content = function()
                                ui.heading {
                                    level = 1,
                        ...
                        ui.container {
                            ...
                            content = function()
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "col-md-6 col-md-col-md-offset--3 text-center label label-success" },
                                            content = function()
                                                                        ...
                                                                        ui.container {
                                                                            ...
                                                                            content = function()
                                                                                ui.link {
                                                                                    ...
                                                                                    content = function()
                                                                                                        ui.container {
                                                                                                            attr = { class = "col-md-2 col-md-col-md-offset-1 spaceline2" },
                                                                                                            content = function()
                                                                                                        ...
                                                                                                        ui.container {
                                                                                                            attr = { class = "col-md-4 col-md-col-md-offset--2 text-center spaceline" },
                                                                                                            content = function()
                                                                                                                ui.heading { level = 2, attr = { class = "spaceline btn btn_large btn-primary" }, content = _ "Vote now" }
                                                                                            end
                                                                                        }
                                                                                    end
                                                                                }
                                ...
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "col-md-12" },
                                            content = function()
                                                ui.heading { level = 3, attr = { class = "label label-fix-size" }, content = _ "Full text" }
                                            end
                                        }
                                        ui.heading {
                                            level = 4,
                                                ...
                                                if not show_as_head then
                                                    ...
                                                    if initiator and initiator.accepted and not initiative.issue.half_frozen and not initiative.issue.closed and not initiative.revoked then
                                                        ui.container {
                                                            ...
                                                            content = function()
                                                                ui.link {
                                                                    attr = { class = "col-md-col-md-offset--7 btn btn-primary col-md-2 text-center" },
                                                                ...
                                                                if drafts_count > 1 then
                                                                    ui.link {
                                                                        attr = { class = "btn btn-primary col-md-col-md-offset-1 col-md-2 text-center spaceline-bottom" },
                                                                        mode = "redirect",
                                                                        module = "draft",
                                                                        view = "list",
                                                                        params = { initiative_id = initiative.id },
                                ...
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            ...
                                            content = function()
                                                ui.heading { level = 3, attr = { class = "label label-fix-size" }, content = _ "Attachments" }
                                            end
                                        }
                                    end
                                }
                                            ...
                                            content = function()
                                                ui.container {
                                                  ...
                                                  ui.container {
                                                    ...
                                                    content = function()
                                                        ui.container {
                                                            attr = { class = "col-md-12 spaceline3" },
                                                            content = function()
                        ...
                        ui.container {
                            ...
                            content = function()
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "col-md-12 text-center label label-fix-size" },
                                            content = function()
                                ...
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            ...
                                            content = function()
                                                ui.link {
                                                    attr = { id = "issue_see_det_" .. issue.id, class = "col-md-4 col-md-col-md-offset-4 text-center" },
                                                    module = "issue",
                                                    view = "show_ext_bs",
                                                    id = issue.id,
                                                    params = {
