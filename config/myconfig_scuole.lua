...
-- ------------------------------------------------------------------------
config.instance_name = "Parlamento Elettronico Online ***SCUOLE***"
...
-- ------------------------------------------------------------------------
config.absolute_base_url = "https://test.parelon.com/parelon/scuole"
...
-- ------------------------------------------------------------------------
config.mail_subject_prefix = "Parlamento Elettronico Online - Edizione Scuole"

-- Sender of all automatic mails, defaults to system defaults
-- ------------------------------------------------------------------------
config.mail_envelope_from = "info@parelon.com"
config.mail_from = { name = "Parlamento Elettronico Online - Edizione Scuole", address = "info@parelon.com" }
...
-- ------------------------------------------------------------------------
config.download_dir = "/opt/replica/parelon_scuole/"
config.db_dump_dir = "/opt/backups/parelon_scuole/"
